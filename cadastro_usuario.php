    ...
    <div class="cadastro-form">
        ...
        <form action="verifica_cadastro_usuario.php" id="cadastro-form" method="POST">
            ...
            <?php
                ...
                if (isset($_SESSION['teste_email'])) {

                    $teste_nome = $_SESSION['teste_nome'];

                    if ($teste_nome == 1) {

                        echo
                            '<div>
                                <p class="red">Você digitou um nome inválido. Digite novamente</p>
                            </div>';
            ...
            <div class="texto">
                <input type="text" placeholder="Email do usuário" name="email" id="email" required="required" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,}" minlength="10" maxlength="50" title="Exemplo: teste@teste.com">
                <span class="check-message hidden">Required</span>
            </div>
            ...
            <?php
                ...
                if (isset($_SESSION['teste_email'])) {
                    ...
                    $teste_email = $_SESSION['teste_email'];
            ...
            <div class="texto">
                <input type="password" name="senha1" id="senha1" placeholder="Senha" minlength="4">
                <span class="check-message hidden">Required</span>
                <!--<i class="fa fa-eye ver_senha" aria-hidden="true" id="eye1"></i>-->
            </div>

            <div class="texto">
                <input type="password" name="senha2" id="senha2" placeholder="Repita a senha" minlength="4">
                <span class="check-message hidden">Required</span>
