                    ...
                    do{
                        ...
                        if($registro1['id_evento'] != null){
                            echo'
                                ...
                                <div class="texto">
                                    <input type="text" placeholder="Solicita levar algo para o evento?(Sim ou não)" name="solic_levar_algo_evento" id="solic_levar_algo_evento" required="required" minlength="3" maxlength="3"  title="Usando letras como A(a) ate z(z)" value ="'.$registro1['solic_levar_algo_evento'].'">
                                    <span class=" check-message hidden">Required</span>
                                </div>

                                <div class="texto">
                                    <input type="text" placeholder="Solicita suporte para o evento?(Sim ou não)" name="solic_suporte_evento" id="solic_suporte_evento" required="required" minlength="3" maxlength="3" title="Usando letras como A(a) ate z(z)" value ="'.$registro1['solic_suporte_evento'].'">
                                    <span class=" check-message hidden">Required</span>
                                </div>

                                <div class="texto">
                                    <input type="text" placeholder="Evento é voluntario e periodico evento?(Sim ou não)" name="evento_voluntario_periodico_evento" id="evento_voluntario_periodico_evento" required="required" minlength="3" maxlength="3" title="Usando letras como A(a) ate z(z)" value ="'.$registro1['evento_voluntario_periodico_evento'].'">
                                    <span class=" check-message hidden">Required</span>
                                </div>
